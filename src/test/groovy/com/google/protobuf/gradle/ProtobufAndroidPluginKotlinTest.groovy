...
class ProtobufAndroidPluginKotlinTest extends Specification {
  private static final List<String> GRADLE_VERSION = ["8.5", "8.9", "8.13"]
  private static final List<String> ANDROID_PLUGIN_VERSION = ["8.1.0", "8.3.0", "8.13.0"]
  private static final List<String> KOTLIN_VERSION = ["1.7.20", "1.8.20", "1.9.20"]
